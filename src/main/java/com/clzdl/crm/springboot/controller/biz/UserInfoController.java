...
public class UserInfoController extends AbstractShiroController {
	...
	public void save(CmUserInfo cmUserInfo, HttpServletRequest request, HttpServletResponse response) throws Exception {
		userInfoService.save(cmUserInfo);
		ajaxSuccess(response);
	}

	@RequestMapping("/list.json")
	public void list(CmUserInfo entity, Integer pageNo, Integer pageSize, HttpServletRequest request,
